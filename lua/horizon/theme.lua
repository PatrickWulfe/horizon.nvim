...
theme.set_highlights = function()
	...
	hl(0, "String", { fg = c.success_green, bg = "NONE" })
	...
	hl(0, "@type", { link = "Type" })
	hl(0, "@type.qualifier", { fg = c.purple, bg = "NONE" })
	hl(0, "@lsp.type.variable", { fg = c.red, bg = "NONE", italic = true })
	...
	hl(0, "CmpItemKindVariable", { fg = c.light_gray, bg = "NONE" })
